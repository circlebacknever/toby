...
Each of these needs a change this skill's Out of scope note already excludes: a signature, a public return type, or module responsibilities. Report the entry, the file:line, and the skill listed, then leave the code alone.
